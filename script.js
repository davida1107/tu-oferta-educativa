const programas = [
    ...
    // --- ESCUELA DE ADMINISTRACIÓN (7 Programas) ---
    ...
    // --- ESCUELA DE COMUNICACIÓN E INFORMÁTICA (4 Programas) ---
...
function updateUI(el, id) {
    ...
    // El texto dentro de la caja de pago también suele verse bien centrado
    ctx.innerHTML = `
